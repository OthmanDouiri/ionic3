<template>
    <ion-page>
      <ion-content>
        <div class="signup-page">
          ...
          <ion-item>
            <ion-select v-model="gender" placeholder="Select your gender" required>
          ...
          <!-- Button -->
          <ion-button class="orange-button" expand="block" router-link="/signup/5">
            Continue
  ...
  <script setup>
  import { IonPage, IonContent, IonButton, IonIcon, IonItem, IonSelect, IonSelectOption } from '@ionic/vue';
