    ...
    <ion-page>
      <ion-content>
        <div class="signup-page">
          ...
          <!-- name Input -->
          <p class="text-start">Your Email</p>
          <ion-item>
            <ion-input v-model="text" type="email" placeholder="Othman@example.com" required></ion-input>
          </ion-item>
        
        
    
          <!-- Button -->
          <ion-button class="orange-button" expand="block" router-link="/signup/3">
            Continue
