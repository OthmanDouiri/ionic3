    ...
    <ion-page>
      <ion-content>
        ...
        <div class="signup-page">
          ...
          <!-- name Input -->
          <p class="text-start">Your full Name</p>
          <ion-item>
            <ion-input v-model="text" type="text" placeholder="Othman D..." required></ion-input>
          </ion-item>
        
        
    
          <!-- Button -->
          <ion-button class="orange-button" expand="block" router-link="/signup/2">
            Continue
